...
def _create_test_pdf(path: Path) -> None:
    ...
    items = [
        ((50, 50), "DrawMind3D Test Drawing", 14),
        # Engineering annotations, positioned as in a real drawing
        ((80, 150), "M10x1.5-6H", 10),
        ((80, 180), "depth 20", 10),
        ((300, 150), "4x M8 THRU", 10),
        ((300, 250), "\u00d88.5H7", 10),
        ((80, 350), "M6", 10),
        ((300, 350), "\u23009.0", 10),
    ]
    build_text_pdf(path, items, width=595, height=842)
