...
If this page shows no hole callouts at all — a cover sheet, a notes or revision
page, an isometric view without dimensions — that is a normal result: return an
empty array []. Do not explain, apologise or describe the page."""
