    ...
    "properties": {
        "metadata": {
            ...
            "properties": {
                ...
                "llm_enhanced": {
                    "type": "boolean",
                    "description": "Whether a model actually contributed to this result",
                },
                "stages": {
                    "type": "array",
                    "description": "What every pipeline step did, in execution order",
                    "items": {
                        "type": "object",
                        ...
                        "properties": {
                            ...
                            "status": {
                                ...
                                "description": (
                                    "partial means the step produced usable output "
                                    "but not for every page"
                                ),
                            },
                            "detail": {"type": "string"},
                        },
                    ...
                    "evidence": {
                        ...
                        "properties": {
                            ...
                            "source": {
                                ...
                                "description": "How the annotation was detected",
                            },
                            "multiplier": {
                                "type": "integer",
        ...
        "other_annotations": {
            "type": "array",
            "description": (
                "Annotations read from the drawing that are outside hole matching, "
                "e.g. depths, tolerances, surface finish"
            ),
            "items": {
                "type": "object",
                "properties": {
        ...
        "summary": {
            ...
            "properties": {
                ...
                "other_annotations": {"type": "integer"},
