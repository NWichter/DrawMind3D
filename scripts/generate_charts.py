...
def load_results():
    nollm = json.loads((RESULTS_DIR / "evaluation_results_nollm.json").read_text(encoding="utf-8"))
    llm = json.loads((RESULTS_DIR / "evaluation_results_llm.json").read_text(encoding="utf-8"))
    return nollm, llm
